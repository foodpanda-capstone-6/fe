...
const UserVoucherPage: React.FC<Props> = ({
  ...
  const addAVoucher = async () => {
    ...
    await fetch(`http://localhost:8081/incentives/all?username=${username}`)
  ...
  return (
    <>
              ...
              >
                <List>
                  ...
                  <ListItem sx={{ fontSize: 11, textAlign: "justify" }}>
                    ...
                    are transferable, which makes them a great gift for your
                    friends and family!
                  </ListItem>
                </List>
              </Paper>
      ...
      <Modal open={openSuccessModal}>
        <Box sx={style}>
          <Typography>Voucher Received!</Typography>
        </Box>
      </Modal>
    </>
  );
